...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        "flex field-sizing-content min-h-20 w-full resize-none rounded-xl border border-border bg-surface-lowest/60 px-4 py-3 text-base text-foreground shadow-inner transition-[background-color,border-color,box-shadow] duration-[140ms] ease-(--ease-standard) outline-none md:text-sm",
